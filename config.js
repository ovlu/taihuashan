...
const CONFIG = { // 主配置对象，包含网站所有配置项
    ...
    // ====================================
    site: { // 网站基础信息配置
        title: "太华山 - 燕云十六声百业搜索", // 网站标题，显示在浏览器标签页
        description: "剑出太华，山河破晓，一梦太华，为我独尊。" // 网站描述，用于SEO优化
    },
    ...
    hero: { // 首页区域配置
        ...
        // 首页字体配置
        typography: { // 首页文字排版配置
            titleSize: "6rem", // 首页标题字体大小
            textShadow: "-0px 0px 0px #000000, 0px 0px 0px #000000,0px 0px 0px #000000,3px 3px 5px #000000;" // 首页标题文字阴影效果，修改数字3（全部都要）位数字可以调整文字阴影大小效果，数字越大阴影越大
        }
    },
    ...
    videoShowcase: { // 视频展示区域配置
        ...
        header: { // 区域头部标题配置
            title: "百业视频", // 区域主标题文字
            subtitle: "-剑出太华，破浪无前，愿你共赏，一梦太华-" // 区域副标题文字
        },
        // 视频区域手机端内容配置（手机端会出现）
        content: { // 视频区域内容元素配置
        ...
        background: { // 视频区域背景媒体配置
            url: "https://s3plus.meituan.net/opapisdk/op_ticket_885190757_1760105956793_qdqqd_yzguvq.png", // 背景媒体文件URL地址
            type: "auto", // 媒体类型检测方式（auto自动检测/video视频/image图片）
    ...
    organizationActivities: { // 组织活动区域配置
        ...
        header: { // 区域头部标题配置
            title: "百业活动", // 区域主标题文字
            subtitle: "-江湖百业，齐聚太华。百业争锋，唯尊太华-" // 区域副标题文字
        },
        // 背景媒体配置
        background: { // 活动区域背景媒体配置
            url: "https://s3plus.meituan.net/opapisdk/op_ticket_885190757_1760106904888_qdqqd_qhccae.png", // 背景视频文件URL地址
            type: "auto", // 媒体类型检测方式（auto自动检测/video视频/image图片）
            fallback: "https://gitee.com/tx-feng/FengHuaWuQue/raw/Vue/Static/background/background1.avif" // 备用图片地址（当主媒体加载失败时使用）
        },
        // 遮罩层配置
    ...
    about: { // 关于我们区域配置
        ...
        subtitle2: "太华山", // 关于我们区域副标题2
        background: "#1A202C", // 关于我们区域背景色
        content: { // 关于我们区域内容配置
            text1: [ // 第一个文本区域内容数组
                "一剑出鞘天地变色，唯我太华笑傲人间", // 第一段文字内容
                "不问来处只论同心，太华之巅共谱风云" // 第二段文字内容
            ],
            text2: [ // 第二个文本区域内容数组
                "兄弟携手纵横天下，太华为盟不负此生", // 第一段文字内容
                "山有太华，风起云涌，群英并肩共赴江湖" // 第二段文字内容
            ]
        }
    },
    ...
    footer: { // 页脚区域配置
        ...
        sections: [ // 页脚内容区块数组
            { // 第一个页脚区块
                title: "太华山", // 区块标题
                content: "共闯江湖，问鼎太华之巅" // 区块内容描述
            },
            { // 第二个页脚区块
                title: "加入我们", // 区块标题
                content: "加入太华，共赴风云之约。" // 区块内容描述
            },
            { // 第三个页脚区块
                title: "关注我们", // 区块标题
                social: [ // 社交媒体链接数组
                    { platform: "抖音", account: "燕云百业-太华山" } // 社交平台信息对象
                ]
            }
        ],
        copyright: "&copy; 2025 燕云十六声百业-太华山-保留所有权利." // 版权信息文字
    },
    ...
    // ====================================
    audio: { // 音频播放器配置
        backgroundMusic: "https://s3plus.meituan.net/opapisdk/op_ticket_885190757_1760192483123_qdqqd_62yj97.m4a", // 背景音乐文件路径，将音频上传图床，后获得的链接
        defaultVolume: 0.4, // 默认音量大小（0-1之间）
